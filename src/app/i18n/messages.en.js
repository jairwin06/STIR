...
const Messages =
{
    ...
    SLEEPER_SUMMARY_MESSAGE: 'Good morning, {name}! Check out your wakeup summary from Stir at {url}',
    NOTICE: 'Heads up!',
    ...
    TOO_EARLY_CONFIRM: 'Stir needs at least {hours} hours to prepare your message. We'll set your wakeup message for the follwing day.',
    ALARM_FAILED_NOTIFY: 'Hi {name}, this is a message from Stir. We tried to deliver your wakeup message at {time, time, short}, but unfortunately the call didn\'t go through. You can still hear your message and get a review of your analysis here: {url}',
